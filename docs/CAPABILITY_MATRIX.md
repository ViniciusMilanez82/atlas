...
| Validação da inteligência e modos (cap. 11) | Sim: validação vinculada; modos Automático/Econômico/Máxima mudam o modelo chamado; perfis não validados nunca usados | Nenhuma validação real | INT, MAC-CI (tela) | Qualidade/custo com modelos reais e avaliações (N13, D-03) |
...
| Distribuição assinada/notarizada (cap. 23.3, 28) | Bundle de desenvolvimento ad-hoc com SBOM CycloneDX | — | E2E-CI (bundle inicia sem Python do sistema) | Assinatura, notarização, instalador, atualização (N23, D-07) |
