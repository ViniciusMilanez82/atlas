...
`.github/workflows/ci.yml` define os jobs. Não há repositório remoto configurado, então o CI
**nunca foi executado**. Publicar o repositório exige autorização do proprietário.
